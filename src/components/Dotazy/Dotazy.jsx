...
class Dotazy extends Component {
	state = {
		dotazy: [
			{q: "Kdy a kde se turnaj koná? (DŮLEŽITÁ AKTUALIZACE)", a: "Celý turnaj se kvůli epidemiologické situaci odehraje v jeden den, a to v úterý, 8. 3. v hale Slezského gymnázia. I když je již známý rozpis zápasů, kontrolujte prosím pravidelně na této stránce, zda se nic nezměnilo. Někdy se zápasy můžou posunout v závislosti na tom, jak to bude vyhovovat učitelům."},
